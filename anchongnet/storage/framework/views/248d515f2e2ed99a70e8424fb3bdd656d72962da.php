                    ...
                    <div class="box">
                        <div class="box-body">
                            <form action="/good" method="get" class="form-horizontal form-inline f-ib">
                                <input type="text" name="keyName" value="<?php echo e($datacol['args']['keyName']); ?>" class="form-control" placeholder="货品编号">
                                ...
                                <?php foreach($datacol['datas'] as $data): ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            data-id="<?php echo e($data['gid']); ?>"
                                            data-gid="<?php echo e($data['goods_id']); ?>">删除</button>
                ...
                <div class="modal-body">
                    ...
                    <form role="form" class="form-horizontal" action="" method="post" id="updateform">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="spetag" id="spetag" class="form-control" required placeholder="如：黄色32码" value="<?php echo e(old('spetag')); ?>" readonly="true"/>
                            </div>
                        </div><!--end form-group-->
                        <div class="form-group">
