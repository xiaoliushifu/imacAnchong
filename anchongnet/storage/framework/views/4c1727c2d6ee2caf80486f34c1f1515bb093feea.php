						...
						<div class="box-body">
							...
							<table id="example1" class="table table-bordered table-striped">
								...
								<tr>
									...
									<td align="center">
										<img style="height:100px;width:100px;" src="<?php echo e($data['img']); ?>">
									</td>
									<td align="center">
										<button type='button' class='edit f-ib btn btn-primary btn-xs' data-toggle="modal" data-id="<?php echo e($data['infor_id']); ?>" data-target="#myModal">编辑</button>
										<button type="button" class="del f-ib btn btn-danger btn-xs" data_id=<?php echo e($data['infor_id']); ?>>删除</button>
									</td>
								</tr>
								<?php endforeach; ?>
								<tr>
