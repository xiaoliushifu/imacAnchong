  ...
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="/checklogin" method="post">
     <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
      <div class="row cl">
          <font color="red"><?php echo e(Session::get('loginmes')); ?></font>
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img src="<?php echo e(URL('/captcha/1')); ?>" id="captchapic" onclick="javascript:captcha();">  <font color="red"><?php echo e(Session::get('admincaptcha')); ?></font> </div>
      </div>
      <div class="row">
        <div class="formControls col-8 col-offset-3">
