						...
						<div class="box-body">
						    <form  method="post" class="form-horizontal  f-ib" id="myform">
						        <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="username" id="username" placeholder="账号20位以下的纯数字" class="form-control" value="" required   />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" style="text-align: center;">
						            <button  type="submit" style="align:center;" class="btn btn-primary btn-info">注册</button>
                                </div>
						    </form>
						</div>
						<!-- /.box-body -->
