        ...
        <section class="col-lg-7 connectedSortable" style="width:100%">
          ...
          <div class="box box-success">
            ...
            @foreach ($datacol as $data)
              <!-- chat item -->
              <div class="item">
                <img style="border: 0px" src=<?php echo $data['headpic']?$data['headpic']:"/admin/dist/img/user2-160x160.jpg" ?> alt="user image" class="online">

                <p class="message">
                  <a href="#" class="name">
                    <small class="text-muted pull-right"><i class="fa fa-clock-o"></i> {{$data['created_at']}}</small>
                    {{$data['name']}}
                  </a>
                 <b style="font-size:18px">{{$data['title']}}</b>
                </p>
                <div class="attachment">

                  <p style="font-weight:normal" class="filename">
                    <?php if(strlen($data['content']) > 300){
