                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach ($datacol['datas'] as $data)
                                    <tr>
                                        ...
                                        <td align="center">
                                            <button type='button' class='edit f-ib btn btn-primary btn-xs' data-id="{{$data['cid']}}" data-pid="{{$data['parent_id']}}" data-toggle="modal" data-target="#myModal">编辑</button>
                                            <button type="button" class="del f-ib btn btn-danger btn-xs" data-id="{{$data['cid']}}">删除</button>
                                        </td>
                                    </tr>
                                @endforeach
                                <tr>
