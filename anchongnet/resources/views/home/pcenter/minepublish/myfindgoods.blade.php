...
@section('publish')
    <div class="publish" style="position: absolute;top: 5px;right: 0px;">
        <a href="{{url('sergoods/create')}}"><img src="home/images/pcenter/publish.jpg" alt=""></a>
    </div>
@endsection
    @section('content')
    ...
    <div class="mainrg">
        <div class=" daomain">
            <ul>
                ...
                <li><a href="{{url('fngoods')}}" style="color: #1DABD8;font-size: 20px;
                font-weight: bold;">找货</a></li>
