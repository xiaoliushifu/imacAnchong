    ...
    <div class="topt-1">
        ...
        <div class="topt-3">
            <ul  class="nav navbar-nav">
                ...
                <li style="padding-left: 10px;"><a href="#" class="dropdown-toggle fxz" data-toggle="dropdown">风信子<b class="caret"></b></a>
...
<div class="main">
    ...
    <div class="mainrg">
        <div class=" daomain">
            <ul>
                <li><a href="#"style="font-weight: bold;color: #1DACD8;">商品</a></li>
                <li><a href="#">商铺</a></li>
                <li><a href="#">社区</a></li>
