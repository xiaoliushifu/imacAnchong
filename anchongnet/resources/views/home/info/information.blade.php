            ...
            <li class="share">
                <ul>
                    <li class="share-title">
                        <h2>干货分享</h2>
                        <i>More</i>
                        <a class=""><img src="images/upload.png"></a>
                    </li>
                    <span class="parting"></span>
                    <li class="share-item">
                        <a  class="download" href=""><img src="images/download.png"></a>
            ...
            <ul>
                <li>
                    <ul class="info-nav">
                        ...
                        <li class="paging">
                            <a class="pageup"><img src="images/pageup.png"></a>
                            <a class="pagedown"><img src="images/pagedown.png"></a>
                        </li>
                    </ul>
                </li>
                <li class="info-item">
