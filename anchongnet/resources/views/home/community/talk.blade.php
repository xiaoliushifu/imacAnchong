    ...
    <div class="middle-container">
                ...
                <ul class="chat-show">
                    ...
                    <li class="chat-content">
                        ...
                        <p class="comments-share">
                            <a class="comments" href="{{url('/community/'.$value -> chat_id).'/#comments'}}"><img src="home/images/chat/talk.png">{{$tnum[$value-> chat_id]}}</a>
                        </p>
                    </li>
                </ul>
            </li>
        ...
        <div class="pages">
            ...
            <ul class="page-skip">
                ...
                <a class="page-btn" href="{{$talk->url($talk->currentPage())}}">确定</a>
            </ul>
            <div class="cl"></div>
        </div>
    </div>
