                ...
                <ul class="chat-show">
                    ...
                    <li class="chat-content">
                        ...
                        <p class="comments-share">
                            <a class="comments" href="{{url('/community/'.$value -> chat_id).'/#comments'}}"><img src="home/images/chat/talk.png">{{$qnum[$value-> chat_id]}}</a>
                        </p>
                    </li>
                </ul>
            </li>
...
<script>
    ...
    function changePage(obj) {
        ...
        if((/^(\+|-)?\d+$/.test(num))&&num>0&&num<={{$question->lastpage()}}){
            ...
            layer.alert('请输入数字并小于等于"{{$question->lastpage()}}"',{offset: ['150px', '821px']});
