...
<html lang="en">
    ...
    <body>
      ...
      <div class="login-page" style="padding:20px;">
        <div class="titles"><h1>安虫</h1></div>
        <h4 class="title" style="margin-top:20px">
          <span>
            <a class="active" data-pjax="true" href="#">登录</a>
          </span>
        </h4>
        <div id="pjax-container">

    <div class="sign-in">
      <form class="form-horizontal" data-js-module="sign-in" action="/user/sharelogin" accept-charset="UTF-8" method="POST">
